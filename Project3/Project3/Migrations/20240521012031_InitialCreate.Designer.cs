...
namespace Project3.Migrations
{
    ...
    [Migration("20240521012031_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project3.Models.Transactions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project3.Models.Routers", b =>
                {
                    b.HasOne("Project3.Models.Station", "EndStations")
                        .WithMany()
                        .HasForeignKey("EndStation")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project3.Models.Station", "StartStation")
                        .WithMany()
            ...
            modelBuilder.Entity("Project3.Models.TrainSchedule", b =>
                {
                    b.HasOne("Project3.Models.Station", "EndStation")
                        .WithMany()
            ...
            modelBuilder.Entity("Project3.Models.Transactions", b =>
                {
                    ...
                    b.HasOne("Project3.Models.Station", "FromStation")
                        .WithMany()
                        .HasForeignKey("FromStationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project3.Models.Station", "ToStation")
                        .WithMany()
