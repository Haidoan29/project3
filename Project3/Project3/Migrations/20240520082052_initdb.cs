    ...
    public partial class initdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CancellationFeeRules", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PRNNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumCoachesAC3 = table.Column<int>(type: "int", nullable: false),
                    NumCoachesFirstClass = table.Column<int>(type: "int", nullable: false),
                    NumCoachesSleeper = table.Column<int>(type: "int", nullable: false),
